        ...
        <Container>
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="justify-content-center" style={{marginLeft:'300px'}}>
              ...
              <Button onClick={handleShow} style={{marginLeft:'300px',backgroundColor:"black",color:"white",border:'solid 3px white'}}>Cart</Button><span style={{color:"white",marginLeft:'10px'}}>0</span>
            </Nav>
          </Navbar.Collapse>
        </Container>
      </Navbar>
